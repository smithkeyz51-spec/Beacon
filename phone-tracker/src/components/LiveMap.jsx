...
// with Vite — build a simple inline SVG icon instead so it always renders.
const beaconIcon = new L.DivIcon({
  className: 'beacon-marker',
  html: `<div style="
    width:16px;height:16px;border-radius:50%;
    background:#22D48A;border:2px solid #0B0F14;
    box-shadow:0 0 0 4px rgba(34,212,138,0.25);
  "></div>`,
  iconSize: [16, 16],
  iconAnchor: [8, 8]
})
...
export default function LiveMap({ location }) {
  ...
  return (
    ...
    >
      <TileLayer
        // CartoDB dark tiles — free, no API key, fits the "night map" palette
